...
public class SnapNewNodesPreferenceSetting extends DefaultTabPreferenceSetting {
    ...
    static final String DIST_FACTOR = "snap-new-nodes.dist.factor";
    static final String DIST_THRESHOLD = "snap-new-nodes.dist.threshold";
    static final String AREA_FACTOR = "snap-new-nodes.area.factor";
    static final String AREA_THRESHOLD = "snap-new-nodes.area.threshold";
    static final String ANGLE_FACTOR = "snap-new-nodes.angle.factor";
    static final String ANGLE_THRESHOLD = "snap-new-nodes.angle.threshold";
    static final String MERGE_THRESHOLD = "snap-new-nodes.merge.threshold";
    ...
    public SnapNewNodesPreferenceSetting() {
        super("snapnewnodes", tr("Snap New Nodes"), tr("Node of the way (area) is removed if all of <u>Angle Weight</u>, <u>Area Weight</u> and <u>Distance Weight</u> are greater than 1. " +
